...
module.exports = {
  ...
  output: {
    path: path.resolve(__dirname, "dist"), // можно указать bild
    publicPath: "/",
  },
  ...
  plugins: [
    new HtmlWebpackPlugin({
      title:"messenger",
      template: path.resolve(__dirname, "public/index.html"), // где лежит наш html-файл до сборки
      inject: true,
      minify: {
  ...
  devServer: {
    ...
    contentBase: path.resolve(__dirname, "dist"), // можно указать bild
    open: true,
    hot: true,
    port: 3000,
  },
